...
// https://github.com/refs/ocis-mono/ocis-accounts/issues/61
...
// https://github.com/refs/ocis-mono/ocis-accounts/issues/62
	...
	tests := []struct {
		...
		},
		{
			...
			&proto.Account{
				...
				GidNumber:                   1000,
				// No email validation
				// https://github.com/refs/ocis-mono/ocis-accounts/issues/77
				Mail: "1.2@3.c_@",
			},
		},
	}
